...
public class SuggestedFriendService {
	...
	public static ArrayList<User> getSuggestedFriends(ArrayList<User> al_friends,String myEmailID)
	{
		...
		try {
				...
				PreparedStatement prepStatement = connect.con.prepareStatement("select * from User u1,User u2 where "
						+ "u1.emailID=? and (u1.college=u2.college or u1.hometown=u2.hometown or u1.highschool=u2.highschool) ");
